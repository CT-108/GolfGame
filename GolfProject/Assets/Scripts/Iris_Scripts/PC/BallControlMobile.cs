...
public class BallControlMobile : MonoBehaviour
{
    public static BallControlMobile Instance;
    ...
    private void Update()
    {
        ...
        if(Input.touchCount > 0)
        {
            ...
            if (touch.phase == TouchPhase.Began && isAbleToShoot == true && !camScript.camIsMoving && !(numberHit >= limitHits[(_currentLimitHit)]))
            {
                isBeingHeld = true;
                DragStart();
            }
